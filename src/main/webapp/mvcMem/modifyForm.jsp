	...
	<form method="post" action="member.mdo?cmd=modifyProc" name="regForm">
		<table border="1">
			...
			<tr>
				...
				<td><input type="hidden" name="id"  value="${id}" />&nbsp;<c:out value="${id}"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				</select>- <input type="text" name="phone2" size="5"  value="${phone2}"/>- <input type="text"
					name="phone3" size="5" value="${phone3}" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right">우편변호:</td>
				<td><input type="text" name="zipcode" value="${zipcode}" /> <input type="button"
			...
			<tr>
				<td colspan="2" align="center"><input type="button"
					...
					type="reset" value="취소" onclick="javascript:window.location='member.mdo?cmd=login'"/></td>
			</tr>
		</table>
	</form>
</body>
